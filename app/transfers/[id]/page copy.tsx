...
const StatCard: React.FC<StatCardProps> = ({
    ...
    <motion.div
        ...
        transition={{ delay }}
        className={`bg-white rounded-2xl border border-gray-200 shadow-sm p-5 flex items-center gap-4 ${wide ? 'col-span-2' : ''}`}
    >
        <div
        ...
        >
            ...
            <td className="px-6 py-4">
                <button
                    ...
                    className="inline-flex items-center gap-2 px-3 py-2 border border-gray-200 bg-white text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 hover:border-[#010804]/20 hover:text-[#010804] transition-all duration-200"
...
const TransfersPage = ({ user }: { user: User }) => {
    ...
    // Calculate serial number offset for current page
    const serialOffset = (paginationMeta.current_page - 1) * paginationMeta.per_page;
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                ...
                {/* Stats Row - 5 columns with Total Value wider */}
                                    ...
                                    <tbody>
                                        {filteredTransfers.map((transfer, index) => (
                                            <TransferRow
                                                ...
                                                serialNumber={serialOffset + index + 1}
                                            />
                                        ))}
                                    </tbody>
                                </table>
