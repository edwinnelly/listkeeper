              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-indigo-50 rounded-2xl p-6 mb-6 border border-gray-200">
                      ...
                      <button 
                        onClick={() => setShowUpgradeModal(true)}
                        className="w-full bg-white text-gray-600 border border-gray-200 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-300 text-sm"
                      >
                        Upgrade Plan
                      </button>
                    </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
                  <div className="flex justify-between items-center mb-8">
                    <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                      <History className="h-7 w-7 text-gray-500" />
                      Payment History
                    </h2>
