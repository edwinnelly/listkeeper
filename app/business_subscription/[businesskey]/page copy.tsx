...
const BusinessProfilePage = () => {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "subscription" | "payment-history" | "settings">("overview");
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="flex items-center space-x-8 mb-8 lg:mb-0">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xl font-medium">{business.industry_type}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-semibold rounded-2xl hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl group"
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex items-center space-x-5 p-6 bg-gray-50 rounded-2xl border border-gray-200 hover:shadow-md transition-all duration-300 group hover:scale-[1.02]">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 font-semibold text-lg">Null</p>
                        </div>
                      </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-6 border border-blue-200">
                      <h4 className="text-2xl font-bold text-gray-900 mb-2">{business.subscription.plan_name}</h4>
                      ...
                      <div className="space-y-3 mb-4">
                        <div className="flex items-center gap-3 text-gray-700">
                          ...
                          <span className="text-sm">
                            {currentSubscription.users} of {business.subscription.users} users
                          </span>
                        </div>
                        <div className="flex items-center gap-3 text-gray-700">
                      ...
                      <button 
                        onClick={() => setShowUpgradeModal(true)}
                        className="w-full bg-white text-blue-600 border border-purple-200 py-3 rounded-xl font-semibold hover:bg-purple-50 transition-all duration-300 text-sm"
                      >
                        Upgrade Plan
                      </button>
                    </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between p-6 bg-gray-50 rounded-2xl border border-gray-200">
                        ...
                        <span className="text-2xl font-bold text-gray-900">
                          {business.created_at ? new Date(business.created_at).getFullYear() : "N/A"}
                        </span>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-2">
                      {formatPrice(paymentHistory.filter(p => p.status === 'completed').reduce((sum, p) => sum + p.amount, 0))}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">
                      {paymentHistory.filter(p => p.status === 'completed').length} successful payments
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-2">
                      {formatPrice(paymentHistory.filter(p => p.status === 'pending').reduce((sum, p) => sum + p.amount, 0))}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">
                      {paymentHistory.filter(p => p.status === 'pending').length} pending payments
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-2">
                      {formatPrice(paymentHistory.filter(p => p.status === 'failed').reduce((sum, p) => sum + p.amount, 0))}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">
                      {paymentHistory.filter(p => p.status === 'failed').length} failed payments
                    </p>
                  </div>
                </div>
              </div>
