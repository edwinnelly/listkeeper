          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between py-6">
            ...
            <div className="flex items-center space-x-2 sm:self-start">
              ...
              <Link 
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gray-600 hover:bg-gray-700 border border-transparent rounded-lg transition-colors duration-200"
              >
              ...
              <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-200 text-sm">{business.industry}</p>
                  </div>
                    ...
                    <p className="text-gray-900 font-medium">
                      {business.website ? (
                        <a 
                          ...
                          className="hover:text-gray-600 transition-colors duration-200 truncate block"
                        >
                          {business.website}
                        </a>
                      ) : (
