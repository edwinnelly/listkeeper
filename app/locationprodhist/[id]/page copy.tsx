      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-scaleIn">
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="border-t border-stone-200 pt-4">
              ...
              <div className="space-y-2">
                {/* <div className="flex justify-between text-sm">
                  ...
                  <span className="text-stone-900 font-medium capitalize">{history.source_type}</span>
                </div> */}
                {/* <div className="flex justify-between text-sm">
                  <span className="text-stone-500">Source ID</span>
                  <span className="text-stone-900">{history.source_id}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-stone-500">Location ID</span>
                  <span className="text-stone-900">{history.location_id}</span>
                </div> */}
                <div className="flex justify-between text-sm">
            ...
            {/* Business Key */}
            {/* <div className="text-xs text-stone-400 font-mono bg-stone-50 p-2 rounded">
              Business Key: {history.business_key}
            </div> */}
          </div>
