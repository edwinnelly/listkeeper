...
const Dashboard: React.FC<DashboardProps> = ({ business_name }) => {
  return (
              ...
              <nav className="space-y-2">
                {[
                  ...
                  <a
                    key={item}
                    href="#"
                    className="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                  >
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-lg bg-${action.color}-100 flex items-center justify-center mb-2`}
                      >
                        <action.icon
