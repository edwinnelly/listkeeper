...
// Static units array - no API needed
const staticUnits: Unit[] = [
  ...
  { id: 16, name: "Yard", symbol: "yd" },
  { id: 17, name: "Foot", symbol: "ft" },
  { id: 18, name: "Inch", symbol: "in" },
  { id: 19, name: "Square Meter", symbol: "m²" },
  { id: 20, name: "Square Foot", symbol: "ft²" },
];
...
const ManageProducts = () => {
  ...
  const [units, setUnits] = useState<Unit[]>(staticUnits); // Use static array
    ...
    try {
      ...
      const transformedSuppliers = Array.isArray(suppliersArray)
        ? suppliersArray.map((vendor) => ({
            ...
            vid: vendor.vid, // This is the encrypted string ID
  ...
  // Fetch all dropdown data (except units which are static)
  ...
  // Function to clear a specific field error when user starts typing
  ...
  const validateForm = (formData: ProductFormData): string[] => {
    ...
    if (formData.sku.length < 3) errors.push("SKU must be at least 3 characters");
    ...
    try {
      ...
      const optimisticProduct: ProductList = {
        ...
        unit: Array.isArray(units)
          ? units.find((u) => u.name === form.unit_id)
          : undefined,
      ...
      if (status === 403) {
        ...
        if (errors) {
          // Store validation errors for form field display
          ...
          // Also show first error as toast notification
          const firstErrorField = Object.keys(errors)[0];
          const firstErrorMessage = errors[firstErrorField][0];
          toast.error(`${firstErrorField.replace(/_/g, ' ').toUpperCase()}: ${firstErrorMessage}`);
                  ...
                  <div className="space-y-3">
                    {selectedProduct.supplier && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm text-gray-900">
                          {selectedProduct.supplier.vendor_name}
                        </span>
                      </div>
                    )}
...
const ProductModal = ({
  ...
  // Add error input class
  const getInputClass = (fieldName: string) => {
    return `${inputClass} ${hasFieldError(fieldName) ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}`;
  };
    ...
    >
      ...
      >
            ...
            <ul className="list-disc pl-5 text-sm text-red-700">
              {Object.entries(validationErrors).map(([field, errors]) => (
                errors.map((error, index) => (
                  <li key={`${field}-${index}`}>
                    <strong>{field.replace(/_/g, ' ').toUpperCase()}:</strong> {error}
                  </li>
                ))
              ))}
            </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className={labelClass}>
              products_measurements <span className="text-red-500">*</span>
            </label>
            <select
              value={form.unit_id}
              onChange={(e) => handleInputChange("unit_id", e.target.value)}
              required
              className={getInputClass("unit_id")}
            >
            ...
            {hasFieldError("unit_id") ? (
              <p className="mt-1 text-sm text-red-600">{getFieldError("unit_id")}</p>
            ) : (
              Array.isArray(units) && units.length === 0 && (
                <p className="text-xs text-red-500 mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={getInputClass("cost_price")}
              placeholder="0.00"
            />
          ...
          <div>
            ...
            <input
              ...
              className={getInputClass("sale_price")}
              placeholder="0.00"
            />
            {hasFieldError("sale_price") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("sale_price")}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={getInputClass("stock_quantity")}
              placeholder="0"
            />
          ...
          <div>
            ...
            <input
              ...
              className={getInputClass("low_stock_threshold")}
              placeholder="5"
            />
            {hasFieldError("low_stock_threshold") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("low_stock_threshold")}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <input
              ...
              className={getInputClass("discount_percentage")}
              placeholder="0.00"
            />
            {hasFieldError("discount_percentage") && (
          ...
          <div>
            ...
            <input
              ...
              className={getInputClass("discount_start_date")}
            />
            {hasFieldError("discount_start_date") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("discount_start_date")}</p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              className={getInputClass("discount_end_date")}
            />
            {hasFieldError("discount_end_date") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("discount_end_date")}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={getInputClass("manufactured_at")}
            />
            {hasFieldError("manufactured_at") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("manufactured_at")}</p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              className={getInputClass("expires_at")}
            />
            {hasFieldError("expires_at") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("expires_at")}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            {hasFieldError("length") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("length")}</p>
            )}
          </div>
          <div>
            ...
            />
            {hasFieldError("width") && (
              <p className="mt-1 text-sm text-red-600">{getFieldError("width")}</p>
            )}
          </div>
          <div>
        ...
        <div>
          ...
          <select
            ...
            className={getInputClass("supplier_id")}
          >
