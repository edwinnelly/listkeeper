            ...
            <div className="grid grid-cols-2 gap-2">
              {["asc", "desc"].map((order) => (
                <button
                  ...
                  className={`py-2.5 text-sm font-semibold rounded-xl border transition-all ${filters.sortOrder === order
          ...
          {["All", "Active", "Inactive"].map((label) => {
            ...
            return (
              <button key={label}
                ...
                className={`px-3.5 py-1.5 text-xs font-semibold rounded-full transition-all border ${isActive
                ...
                <thead>
                  <tr className="border-b border-stone-100">
                    {["#", "Product", "Barcode", "Category", "Price", "Status", ""].map((h, i) => (
                      <th key={i}
                        className={`px-5 py-3.5 text-left text-[10px] font-bold uppercase tracking-widest text-stone-400 bg-stone-50/70 ${i === 3 ? "hidden lg:table-cell" : i === 5 ? "hidden sm:table-cell" : ""
                          }`}>
                        {h}
                      </th>
                    ))}
