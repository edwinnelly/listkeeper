...
import { apiPost } from "@/lib/axios"; // Use the wrapper's apiPost instead of raw api
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiPost(
        ...
        form,
        {}, // config
        ["/user", "/dashboard"], // Invalidate these cache URLs after successful registration
      );

      setSuccess(
        "Inventory account created successfully! Redirecting to dashboard...",
      );
      setTimeout(() => {
                ...
                >
                  <div className="space-y-6 md:space-y-8 p-4 md:p-6 lg:p-8">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`relative ${isTablet ? "h-10 w-10" : "h-12 w-12 lg:h-14 lg:w-14"}`}
                      >
                        <Image
                          src="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/44_Bitbucket_logo_logos-256.png"
                          alt="ListKeeping Logo"
                      ...
                      <span
                        className={`${isTablet ? "text-2xl" : "text-3xl lg:text-4xl"} font-bold`}
                      >
                        ListKeeping
                      </span>
                    </div>
                    ...
                    <div className="space-y-4 md:space-y-6">
                      <h2
                        className={`${isTablet ? "text-3xl" : "text-3xl lg:text-3xl"} font-bold leading-tight`}
                      >
                        Get Complete Stock Control
                      </h2>
                      <p
                        className={`${isTablet ? "text-base" : "text-lg lg:text-xl"} opacity-90`}
                      >
                        Register for access to real-time inventory tracking,
                        automated stock alerts, and comprehensive warehouse
                        management tools.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4 md:space-y-6 pt-4 md:pt-8">
                      <div className="flex items-start space-x-3">
                        <div className="p-2 bg-white/10 rounded-lg flex-shrink-0">
                          <ShieldRegular
                            className={`${isTablet ? "w-5 h-5" : "w-6 h-6"}`}
                          />
                        </div>
                        <div className="flex-1">
                          <h3
                            className={`${isTablet ? "text-base" : "text-lg"} font-semibold`}
                          >
                            Inventory Security
                          </h3>
                          <p
                            className={`${isTablet ? "text-sm" : "text-base"} text-white/80`}
                          >
                            Role-based access control to protect your stock data
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p
                            className={`${isTablet ? "text-sm" : "text-base"} text-white/80`}
                          >
                            Monitor stock levels and turnover rates across all
                            locations
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="pt-4 md:pt-8">
                      <div
                        className={`flex ${isTablet ? "flex-wrap gap-4" : "items-center space-x-4"} text-sm text-white/70`}
                      >
                        <div
                          className={`${isTablet ? "w-1/3 min-w-[100px]" : "text-center"}`}
                        >
              ...
              >
                <div className="bg-white/95 backdrop-blur-lg rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 border border-white/20">
                  <div className="mb-6 md:mb-8">
                    <h2
                      className={`${isMobile ? "text-2xl" : "text-3xl"} font-bold text-slate-900 text-center`}
                    >
                      KeepListing
                    </h2>
                    <p className="text-slate-600 mt-2 text-center text-sm sm:text-base">
                      Create an account to access your business management
                      system
                    </p>
                  </div>
                  ...
                  >
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 pl-11 rounded-lg border ${
                              getFieldError("name")
                                ...
                                : "border-slate-300 focus:border-gray-600 focus:ring-gray-600/20"
                            } focus:ring-2 outline-none transition-all bg-white text-sm sm:text-base`}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <input
                            ...
                            required
                            className={`w-full px-4 py-3 pl-11 pr-10 rounded-lg border ${
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      >
                        ...
                        <Link
                          href="/terms"
                          className="text-gray-600 hover:underline inline"
                        >
                    ...
                    <div className="relative my-4 sm:my-6">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-3 bg-white text-slate-500 text-xs sm:text-sm">
                          Or register with
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <span className="text-slate-700 font-medium">
                        Warehouse Terminal Registration
                      </span>
                    </button>
                  </form>
                  ...
                  >
                    ...
                    <div className="text-sm text-slate-600 space-y-3 max-h-40 overflow-y-auto pr-2">
                      <p>
                        By registering, you agree to our inventory management
                        policies...
                      </p>
                      <p>All stock data is encrypted and protected...</p>
                      <p>
                        You are responsible for maintaining accurate inventory
                        records...
                      </p>
          ...
          <footer className="py-4 px-4 border-t border-white/10 mt-8">
            <div className="container mx-auto">
              <p className="text-center text-white/60 text-sm">
                &copy; {new Date().getFullYear()} ListKeeping. All rights
                reserved.
              </p>
            </div>
          </footer>
      ...
      {isMobile && (
        <div className="fixed bottom-4 left-4 right-4 z-20">
          <div className="bg-black/60 backdrop-blur-sm rounded-lg p-4 text-white text-center">
            <p className="text-sm">
              ListKeeping • Professional Inventory Management
            </p>
          </div>
        </div>
      )}
