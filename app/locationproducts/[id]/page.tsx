...
interface ProductTableRowProps {
  ...
  onTransferStock: (encryptedPid: string | null, locationId: string | null) => void;
  isOpen: boolean;
...
const ProductTableRow: React.FC<ProductTableRowProps> = memo(({
  ...
  const handleTransferStock = useCallback(() => {
    onTransferStock(product.encrypted_pid, product.encrypted_location_id);
    onToggleOpen(null);
  }, [onTransferStock, product.encrypted_pid, product.encrypted_location_id, onToggleOpen]);
    ...
    <tr className="hover:bg-stone-50/50 transition-colors group">
      ...
      <td className="px-6 py-4 text-center">
        ...
        >
          ...
          >
            <Truck className="h-4 w-4 text-[#080e16]" /> Transfer Stock
          </button>
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-black hover:bg-stone-50 transition border-b border-stone-100"
          >
            <ShoppingCart className="h-4 w-4 text-[#080e16]" /> Purchase Stock
          </button>
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-black hover:bg-stone-50 transition border-b border-stone-100"
          >
            <Undo2 className="h-4 w-4 text-[#080e16]" /> Return Stock
          </button>
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-black hover:bg-stone-50 transition border-b border-stone-100"
          >
            <Percent className="h-4 w-4 text-[#080e16]" /> Price Changes
          </button>
          ...
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-sm text-black hover:bg-stone-50 transition border-b border-stone-100"
          >
            <PackagePlus className="h-4 w-4 text-[#080e16]" /> Update Stock
          </button>
...
const ManageProducts = ({ user }: { user?: User }) => {
  ...
  const handleTransferStock = useCallback((encryptedPid: string | null, locationId: string | null) => {
    if (!encryptedPid || !locationId) return;
